        ...
        <div className="mt-28 px-4 sm:px-10 py-12">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid lg:grid-cols-3 sm:grid-cols-2 gap-10 mt-14">
              <div>
             <MdOutlineSettings className="w-10 h-8 fill-blue-600 mb-4 inline-block" />
                <h3 className="text-xl font-semibold mb-2">Customization</h3>
                <p>Tailor our product to suit your needs.</p>

              </div>
              <div>
              <MdOutlineSecurity  className="w-10 h-8 fill-blue-600 mb-4 inline-block" />
                <h3 className="text-xl font-semibold mb-2">Security</h3>
                <p>Your data is protected by the latest security measures.</p>

              </div>
              <div>
              <FaHandsHelping className="w-10 h-8 fill-blue-600 mb-4 inline-block"  />
