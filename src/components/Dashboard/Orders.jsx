            ...
            {currentOrders.map((order, index) => (
              <tr key={index} className="bg-white border-b hover:bg-gray-50">
                ...
                <td className="px-2 py-1">
                  <button onClick={handleUpdate} className="text-blue-500 hover:underline">Update</button>
                  <button onClick={handleDelete} className="text-red-500 hover:underline ml-4">Delete</button>
                </td>
              </tr>
            ))}
          </tbody>
