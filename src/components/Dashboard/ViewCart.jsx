...
export const ViewCart = ({ user }) => {
  ...
  const fetchData = async () => {
    await axios.get(`${URL}/view-cart/${id}`)
      .then(response => {
  ...
  return (
    <div className="min-h-screen py-8 dark:bg-gray-900">
      {isLoading ? <div className="mt-8 mb-8">
            ...
            <div className="bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
              <div className="flex items-center p-4 md:p-6">
                <div className="flex-shrink-0">
                  <BsCart4 size={50} className="animte:pulse"/>
                </div>

                <div className="flex-1 ml-4">
                  <div className="flex items-center mt-4">
                    <p className="text-xl font-bold text-gray-900 dark:text-gray-100 animte:pulse">
                      Your cart is empty
                    </p>
                  </div>
                </div>
      ...
      </div> : <section className="max-w-screen-xl mx-auto px-4 py-8 sm:py-12">
