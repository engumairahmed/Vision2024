...
export const ProductManagement = ({ user }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values, { resetForm }) => {
      ...
      axios
        .post(`${viteURL}/add-product`, formData, {
          headers: {
  ...
  return (
    <div className="product-container p-4 sm:p-8 w-full mt-4 sm:mt-10">
      <section className="bg-gray-500 dark:bg-gray-900 p-6 sm:p-8 rounded-lg shadow-md">
        ...
        <form onSubmit={formik.handleSubmit} encType="multipart/form-data">
          <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
            ...
            <div className="col-span-2 sm:col-span-2 flex justify-center space-x-6 mb-4">
             
              <div className="flex items-center justify-center bg-gray-300 w-full sm:w-32 h-32 border-2 border-gray-300 rounded-lg">
                {imagePreview ? (
                  <img
                    src={imagePreview}
                    alt="Preview"
              ...
              <div className="flex flex-col items-center justify-center border-2 border-solid border-gray-500 bg-gray-300 w-full sm:w-32 h-32 rounded-lg">
                <input
                  type="file"
                  name="image"
                  id="image"
          ...
          <div className="flex items-center justify-center mt-4">
            <button
              type="submit"
              className="px-4 py-2 text-white bg-blue-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
            >
              Submit
            </button>
          </div>
