                        ...
                        <React.Fragment key={order._id.orderId}>
                            ...
                            <thead className="text-sm text-blue-800 bg-white dark:text-green-400">
                                <tr className="border px-6 py-3">
                                    ...
                                    <th></th>
                                    <th colSpan={2}><button className="text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 m-2 text-sm px-6 py-1.5" onClick={()=>handleView(order._id.orderId)}>View Details</button></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr className=''>
