              ...
              <div className="grid md:grid-cols-2 items-center gap-4 max-w-6xl w-full">
                <div className="border border-white-300 rounded-lg p-6 max-w-md shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto">
                  <form className="space-y-4">
                    <div className="mb-8">
                      <h3 className="text-white-800 text-2xl font-extrabold">Link Expired</h3>
                      <p className="text-white-500 text-sm mt-4 leading-relaxed">The link you followed has expired please request for a new reset link.</p>
                    </div>
                    <div className="!mt-8">
