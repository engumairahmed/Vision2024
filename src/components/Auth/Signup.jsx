    ...
    <div className='bg-black w-22 border-3 rounded-lg flex justify-center'>
      <a href="/">
        <img src="/Logo.png" alt="TradeVista" className='w-20' />
              ...
              <div id='inputs'>
                <div className="mt-2" >
                  <label htmlFor='name' className="text-gray-800 text-xs block ">Full Name</label>
                  <div className="relative flex items-center">
                    <input name="name" id='name' type="text" autoComplete='on' className="w-full bg-transparent text-sm border-2 rounded-lg border-gray-300 focus:border-[#004d40] px-2 py-3 outline-none" placeholder="Full Name" value={formik.values.name} onChange={formik.handleChange} onBlur={formik.handleBlur} />
                ...
                <div className="mt-4">
                  <label htmlFor='email' className="text-gray-800 text-xs block ">Email</label>
                  <div className="relative flex items-center">
                    <input name="email" id='email' type="text" autoComplete='on' className="w-full text-sm border-2 rounded-lg border-gray-300 focus:border-gray-800 px-2 py-3 outline-none" placeholder="Email" value={formik.values.email} onChange={formik.handleChange} onBlur={formik.handleBlur} />
